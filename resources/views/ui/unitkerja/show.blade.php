      ...
      <div class="modal-content">
            ...
            <div class="row">
                <div class="col-lg">
                    ...
                    <div class="form-group">
                        ...
                        <input data-input="datetimepicker" class="form-control">
                    </div>
                    <div class="invalid-feedback">
                        Harus Diisi
                    </div>
                ...
                <div class="col-lg">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="ssp-1" name="ssp" class="custom-control-input">
                            <label class="custom-control-label" for="ssp-1">Ada</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="ssp-2" name="ssp" class="custom-control-input">
            ...
            <div class="row align-items-center mb-3">
                ...
                <div class="col-lg">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="kelengkapan-ttd-1" name="kelengkapan-ttd" class="custom-control-input">
                            <label class="custom-control-label" for="kelengkapan-ttd-1">Lengkap</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="kelengkapan-ttd-2" name="kelengkapan-ttd" class="custom-control-input">
                            <label class="custom-control-label" for="kelengkapan-ttd-2">Kurang Lengkap</label>
                            </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="kelengkapan-ttd-3" name="kelengkapan-ttd" class="custom-control-input">
                            <label class="custom-control-label" for="kelengkapan-ttd-3">Tidak Lengkap</label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tab">
            <div class="row gutters-xs">
                ...
                <div class="col d-sm-flex align-items-start justify-content-end" style="padding-top: 28px">
                    <button class="btn btn-outline-secondary py-2">&times;</button>
                </div>
